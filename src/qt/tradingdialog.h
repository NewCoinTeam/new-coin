...
private slots:
    ...
    void on_BuyNEWC_clicked();
    void on_SellNEWCBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputNEWC_textChanged(const QString &arg1);
    ...
    QString BuyNEWC(QString OrderType, double Quantity, double Rate);
    QString SellNEWC(QString OrderType, double Quantity, double Rate);
